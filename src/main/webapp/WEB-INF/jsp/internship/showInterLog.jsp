                                ...
                                <div class="box box-primary">
                                    <div class="box-body table-responsive">
                                        <table class="table table-bordered table-hover">
                                            ...
                                            <c:forEach items="${internlogs}" var="log">
                                                <tr>
                                                    <td>${log.company.companyName}</td>
                                                    <td>${log.title}</td>
                                                    <td>${log.advisorappraise}</td>
                                                    <td>${log.date}</td>
                                                    <td><button type="button" class="btn" onclick="window.location.href='${pageContext.request.contextPath}/internship/showInterLogDetail?id=${log.id}'">查看</button></td>
                                                </tr>
                                            </c:forEach>
                                        </table>
                                    </div>
                            ...
                            <div class="box-footer">
                                <div class="col-sm-1">
                                    <div class="btn-group pull-left">
                                        <button type="button" class="btn btn-info pull-right" onclick="window.location.href='${pageContext.request.contextPath}/internship/addInterLog'">添加日志</button>
                                    </div>
                                </div>
                            </div>
                        </div>
